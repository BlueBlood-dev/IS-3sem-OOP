...
public class CreateReplenishTransactionCommand : ICommand
{
    public void Execute()
    {
        ...
        System.Console.WriteLine("enter how much money you want to put on account");
        decimal money = Convert.ToDecimal(System.Console.ReadLine());
        Guid transactionId = CentralBank.GetInstance().MakeReplenishTransaction(clientId, accountId, bankId, money);
        System.Console.WriteLine($"replenish transaction was created. it's id is: {transactionId}");
    }
}